   ...
   public void deleteById(Long id){
	...
	public Evaluation save (Evaluation evaluation){
	       ...
	       if(foundedEvaluation!=null)
	          ...
	          if(evaluation.getCreatedBy()!=null){
				    User createdBy = userService.findByUsername(evaluation.getCreatedBy().getUsername());
				  if(createdBy == null)
				  evaluation.setCreatedBy(userService.save(evaluation.getCreatedBy()));
				  else
				  evaluation.setCreatedBy(createdBy);
			  }
	    
	          if(evaluation.getUpdatedBy()!=null){
				    User updatedBy = userService.findByUsername(evaluation.getUpdatedBy().getUsername());
				  if(updatedBy == null)
				  evaluation.setUpdatedBy(userService.save(evaluation.getUpdatedBy()));
				  else
				  evaluation.setUpdatedBy(updatedBy);
			  }
