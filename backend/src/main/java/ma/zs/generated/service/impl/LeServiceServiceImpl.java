   ...
   public void deleteById(Long id){
	...
	public LeService save (LeService leService){
	       ...
	       if(foundedLeService!=null)
	          ...
	          if(leService.getCreatedBy()!=null){
				    User createdBy = userService.findByUsername(leService.getCreatedBy().getUsername());
				  if(createdBy == null)
				  leService.setCreatedBy(userService.save(leService.getCreatedBy()));
				  else
				  leService.setCreatedBy(createdBy);
			  }
	    
	          if(leService.getUpdatedBy()!=null){
				    User updatedBy = userService.findByUsername(leService.getUpdatedBy().getUsername());
				  if(updatedBy == null)
				  leService.setUpdatedBy(userService.save(leService.getUpdatedBy()));
				  else
				  leService.setUpdatedBy(updatedBy);
			  }
