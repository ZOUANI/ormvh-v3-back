   ...
   public void deleteById(Long id){
	...
	public CategorieModelLettreReponse save (CategorieModelLettreReponse categorieModelLettreReponse){
	       ...
	       if(foundedCategorieModelLettreReponse!=null)
	          ...
	          if(categorieModelLettreReponse.getUpdatedBy()!=null){
				    User updatedBy = userService.findByUsername(categorieModelLettreReponse.getUpdatedBy().getUsername());
				  if(updatedBy == null)
				  categorieModelLettreReponse.setUpdatedBy(userService.save(categorieModelLettreReponse.getUpdatedBy()));
				  else
				  categorieModelLettreReponse.setUpdatedBy(updatedBy);
			  }
	    
	          if(categorieModelLettreReponse.getCreatedBy()!=null){
				    User createdBy = userService.findByUsername(categorieModelLettreReponse.getCreatedBy().getUsername());
				  if(createdBy == null)
				  categorieModelLettreReponse.setCreatedBy(userService.save(categorieModelLettreReponse.getCreatedBy()));
				  else
				  categorieModelLettreReponse.setCreatedBy(createdBy);
			  }
