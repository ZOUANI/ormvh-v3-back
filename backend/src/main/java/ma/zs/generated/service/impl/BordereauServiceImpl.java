   ...
   public void deleteById(Long id){
	...
	public Bordereau save (Bordereau bordereau){
	       ...
	       if(foundedBordereau!=null)
	          ...
	          if(bordereau.getCreatedBy()!=null){
				    User createdBy = userService.findByUsername(bordereau.getCreatedBy().getUsername());
				  if(createdBy == null)
				  bordereau.setCreatedBy(userService.save(bordereau.getCreatedBy()));
				  else
				  bordereau.setCreatedBy(createdBy);
			  }
	    
	          if(bordereau.getUpdatedBy()!=null){
				    User updatedBy = userService.findByUsername(bordereau.getUpdatedBy().getUsername());
				  if(updatedBy == null) {
					     bordereau.setUpdatedBy(userService.save(bordereau.getUpdatedBy()));

				  }
				  else {
				     bordereau.setUpdatedBy(updatedBy);
