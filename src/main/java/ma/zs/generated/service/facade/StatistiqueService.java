...
public interface StatistiqueService {
    ...
    Map<String, List<StatistiqueVo>> countCourrierByExpeditorNationality(Date dateMin, Date dateMax);

    Map<String, List<StatistiqueVo>> countCourrierByDestinatorNationality(Date dateMin, Date dateMax);
