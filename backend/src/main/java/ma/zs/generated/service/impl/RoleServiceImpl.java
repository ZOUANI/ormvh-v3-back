	...
	public Role save (Role role){
	       ...
	       if(foundedRole!=null)
	          ...
	          if(role.getUpdatedBy()!=null){
				    User updatedBy = userService.findByUsername(role.getUpdatedBy().getUsername());
				  if(updatedBy == null)
				  role.setUpdatedBy(userService.save(role.getUpdatedBy()));
				  else
				  role.setUpdatedBy(updatedBy);
			  }
	    
	          if(role.getCreatedBy()!=null){
				    User createdBy = userService.findByUsername(role.getCreatedBy().getUsername());
				  if(createdBy == null)
				  role.setCreatedBy(userService.save(role.getCreatedBy()));
				  else
