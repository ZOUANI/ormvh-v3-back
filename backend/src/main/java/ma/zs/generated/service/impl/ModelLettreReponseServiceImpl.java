	...
	public ModelLettreReponse save (ModelLettreReponse modelLettreReponse){
	       ...
	       if(foundedModelLettreReponse!=null)
	          ...
	          if(modelLettreReponse.getCategorieModelLettreReponse()!=null){
				  ...
				  if(categorieModelLettreReponse == null)
				  modelLettreReponse.setCategorieModelLettreReponse(categorieModelLettreReponseService.save(modelLettreReponse.getCategorieModelLettreReponse()));
				  else
				  modelLettreReponse.setCategorieModelLettreReponse(categorieModelLettreReponse);
			  }
	    
	          if(modelLettreReponse.getCreatedBy()!=null){
				    User createdBy = userService.findByUsername(modelLettreReponse.getCreatedBy().getUsername());
				  if(createdBy == null)
				  modelLettreReponse.setCreatedBy(userService.save(modelLettreReponse.getCreatedBy()));
				  else
				  modelLettreReponse.setCreatedBy(createdBy);
			  }
	    
	          if(modelLettreReponse.getUpdatedBy()!=null){
				    User updatedBy = userService.findByUsername(modelLettreReponse.getUpdatedBy().getUsername());
				  if(updatedBy == null)
				  modelLettreReponse.setUpdatedBy(userService.save(modelLettreReponse.getUpdatedBy()));
				  else
				  modelLettreReponse.setUpdatedBy(updatedBy);
			  }
