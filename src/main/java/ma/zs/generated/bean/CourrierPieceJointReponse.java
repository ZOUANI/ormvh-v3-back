...
@Entity
public class CourrierPieceJointReponse {

    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    private Long id;
    private String chemin;
    private String absoluteChemin = "C:\\Users\\" + System.getProperty("user.name") + "\\pieces-jointes-reponse\\" + chemin;
	...
	public CourrierPieceJointReponse() {
		super();
		// TODO Auto-generated constructor stub
		this.absoluteChemin = "C:\\Users\\" + System.getProperty("user.name") + "\\pieces-jointes-reponse\\" + chemin;
	}


	public CourrierPieceJointReponse(Long id, String chemin, byte[] contenu, String type, Courrier courier) {
		super();
		this.id = id;
		this.chemin = chemin;
		this.contenu = contenu;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CourrierPieceJointReponse other = (CourrierPieceJointReponse) obj;
		if (chemin == null) {
