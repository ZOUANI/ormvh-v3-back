	...
	public Courrier save (Courrier courrier){
	       ...
	       if(foundedCourrier!=null)
	          ...
	          if(courrier.getCourrierObject()!=null){
				  ...
				  if(courrierObject == null)
				  courrier.setCourrierObject(courrierObjectService.save(courrier.getCourrierObject()));
				  else
	          ...
	          if(courrier.getVoie()!=null){
				  ...
				  if(voie == null)
				  courrier.setVoie(voieService.save(courrier.getVoie()));
				  else
	          ...
	          if(courrier.getNatureCourrier()!=null){
				  ...
				  courrier.setNatureCourrier(natureCourrierService.save(courrier.getNatureCourrier()));
				  else
	          ...
	          if(courrier.getLinkedTo()!=null){
				  ...
				  if(linkedTo == null)
				   	 courrier.setLinkedTo(save(courrier.getLinkedTo()));
				  else
	          ...
	          if(courrier.getExpeditor()!=null){
				  ...
				  if(expeditor == null)
				  courrier.setExpeditor(expeditorService.save(courrier.getExpeditor()));
				  else
	          ...
	          if(courrier.getDestinator()!=null){
				  ...
				  if(destinator == null)
				  courrier.setDestinator(expeditorService.save(courrier.getDestinator()));
				  else
	          ...
	          if(courrier.getCoordinator()!=null){
				  ...
				  if(coordinator == null)
				  courrier.setCoordinator(leServiceService.save(courrier.getCoordinator()));
				  else
	          ...
	          if(courrier.getEmetteur()!=null){
				  ...
				  if(emetteur == null)
				  courrier.setEmetteur(leServiceService.save(courrier.getEmetteur()));
				  else
	          ...
	          if(courrier.getEvaluation()!=null){
				  ...
				  if(evaluation == null)
				  courrier.setEvaluation(evaluationService.save(courrier.getEvaluation()));
				  else
	          ...
	          if(courrier.getExpeditorType()!=null){
				  ...
				  if(expeditorType == null)
				  courrier.setExpeditorType(expeditorTypeService.save(courrier.getExpeditorType()));
				  else
	          ...
	          if(courrier.getSubdivision()!=null){
				  ...
				  if(subdivision == null)
				  courrier.setSubdivision(subdivisionService.save(courrier.getSubdivision()));
				  else
	          ...
	          if(courrier.getStatus()!=null){
				  ...
				  if(status == null)
				  courrier.setStatus(statusService.save(courrier.getStatus()));
				  else
	          ...
	          if(courrier.getTypeCourrier()!=null){
				  ...
				  courrier.setTypeCourrier(typeCourrierService.save(courrier.getTypeCourrier()));
				  else
				  courrier.setTypeCourrier(typeCourrier);
			  }
	    
	          if(courrier.getCreatedBy()!=null){
				    User createdBy = userService.findByUsername(courrier.getCreatedBy().getUsername());
				  if(createdBy == null)
				  courrier.setCreatedBy(userService.save(courrier.getCreatedBy()));
				  else
				  courrier.setCreatedBy(createdBy);
			  }
	    
	          if(courrier.getUpdatedBy()!=null){
				    User updatedBy = userService.findByUsername(courrier.getUpdatedBy().getUsername());
				  if(updatedBy == null)
				  courrier.setUpdatedBy(userService.save(courrier.getUpdatedBy()));
				  else
				  courrier.setUpdatedBy(updatedBy);
			  }
