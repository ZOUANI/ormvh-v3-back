   ...
   public void deleteById(Long id){
	...
	public Voie save (Voie voie){
	       ...
	       if(foundedVoie!=null)
	          ...
	          if(voie.getCreatedBy()!=null){
				    User createdBy = userService.findByUsername(voie.getCreatedBy().getUsername());
				  if(createdBy == null)
				  voie.setCreatedBy(userService.save(voie.getCreatedBy()));
				  else
				  voie.setCreatedBy(createdBy);
			  }
	    
	          if(voie.getUpdatedBy()!=null){
				    User updatedBy = userService.findByUsername(voie.getUpdatedBy().getUsername());
				  if(updatedBy == null)
				  voie.setUpdatedBy(userService.save(voie.getUpdatedBy()));
				  else
				  voie.setUpdatedBy(updatedBy);
			  }
