...
@Component 
public class ExpeditorTypeConverter extends AbstractConverter<ExpeditorType,ExpeditorTypeVo>{ 
	...
	public  ExpeditorTypeConverter(){
		init(true);
	}

	@Override 
 	public ExpeditorType toItem(ExpeditorTypeVo vo) {
 	if (vo == null) {
   	 return null;
      } else {
      	ExpeditorType item = new ExpeditorType();
 	 ...
 	 @Override 
 	public ExpeditorTypeVo toVo(ExpeditorType item) {
 		if (item == null) {
    		return null;
      	} else {
			ExpeditorTypeVo vo = new ExpeditorTypeVo();
