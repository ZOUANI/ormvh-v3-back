	...
	public User save (User user){
	       ...
	       if(foundedUser!=null)
	          ...
	          if(user.getCreatedBy()!=null){
                          User createdBy  = findByUsername(user.getCreatedBy().getUsername());
				  if(createdBy == null)
				   	 user.setCreatedBy(save(user.getCreatedBy()));
				  else
				  user.setCreatedBy(createdBy);
			  }
	    
	          if(user.getUpdatedBy()!=null){
                          User updatedBy  = findByUsername(user.getUpdatedBy().getUsername());
				  if(updatedBy == null)
				   	 user.setUpdatedBy(save(user.getUpdatedBy()));
				  else
